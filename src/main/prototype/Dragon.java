...
public class Dragon implements Cloneable {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("dragon1.texture == dragon2.texture: " + (dragon1.texture == dragon2.texture));
        System.out.println("dragon1.name.equals(dragon2.name): " + dragon1.name.equals(dragon2.name));
        System.out.println("dragon1.color.equals(dragon2.color): " + dragon1.color.equals(dragon2.color));
        System.out.println("Arrays.equals(dragon1.texture, dragon2.texture): "
